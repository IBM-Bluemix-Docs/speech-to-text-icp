...
-   [Creating a custom language model](/docs/speech-to-text-icp?topic=speech-to-text-icp-languageCreate)
...
-   [Creating a custom acoustic model](/docs/speech-to-text-icp?topic=speech-to-text-icp-acoustic)
...
For more information, see [Using custom acoustic and custom language models together](/docs/speech-to-text-icp?topic=speech-to-text-icp-useBoth).
...
You can use both broadband and narrowband models with any supported language. If a language supports language model customization, it also supports grammars. For a list of all available models, see [Supported language models](/docs/speech-to-text-icp?topic=speech-to-text-icp-models#modelsList).
...
If necessary, you can then delete the data by using the `DELETE /v1/user_data` method. For more information, see [Information security](/docs/speech-to-text-icp?topic=speech-to-text-icp-information-security).
