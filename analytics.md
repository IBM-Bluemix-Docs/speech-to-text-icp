...
-   [About {{site.data.keyword.toneanalyzershort}} ![External link icon](../../icons/launch-glyph.svg "External link icon")](https://{DomainName}/docs/tone-analyzer?topic=tone-analyzer-about#about){: new_window}
-   [About {{site.data.keyword.nlushort}} ![External link icon](../../icons/launch-glyph.svg "External link icon")](https://{DomainName}/docs/natural-language-understanding?topic=natural-language-understanding-about#about){: new_window}
...
Otherwise, all descriptions and methods of the batch-processing interface apply just as they do without speech analytics. You can use the API to initiate, check the status of, cancel, or delete a batch-processing request. You can use the Admin Console GUI to check the status of all requests. For more information, see the batch-processing [Usage model](/docs/speech-to-text-icp?topic=speech-to-text-icp-batch#batchUsage).
